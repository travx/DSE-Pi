...
public class PiGlow {
    ...
    public void shineLights(byte brightness, int... lightnrs) throws IOException{
        device.write(CMD_SET_PWM_VALUES, lightOnArray(brightness, lightnrs), 0, 18);
